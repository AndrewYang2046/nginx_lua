...
--代理地址及key值定义
local proxy_a = "172.28.247.111:8083"
local proxy_b = "172.28.250.2:8083"
local proxy_a_key = "SAND_GRAY_CHANNEL_TOPIC_SMP-PAY-CLIENT01"
local proxy_b_key = "SAND_GRAY_CHANNEL_TOPIC_SMP-PAY-CLIENT02"
...
--获取数据
local resp_a, err = red:get(proxy_a_key)
...
local resp_b, err = red:get(proxy_b_key)
